...
What is the distinction between the rationals and the reals? Intuitively, we might think about the rationals as having "gaps" that are "filled in" by the reals: we know that $x^2=2$ does not have a solution in $\Q$, but it does in $\R.$ 
...
This theorem has some amazing consequences!
